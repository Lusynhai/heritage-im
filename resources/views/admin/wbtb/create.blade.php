...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Tambah Data WBTB Kabupaten Indramayu</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('wbtb.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="container">
                                <div class="row justify-content-start">
                                    ...
                                    <div class="col-5 mb-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="document" class="form-control" id="deskripsi" rows="3" ></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori_wbtb_id" required>
                                                ...
                                                @empty
                                                <option value="NULL">kategori Objek budaya belum diinput</option>
                                                @endforelse
                                            </select>
                                        </div>
                                    </div>
